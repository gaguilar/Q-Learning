...
public class QTableGUI extends javax.swing.JFrame {
     ...
     */
    JPanel[][] jPanelsState0;
    JPanel[][] jPanelsState1;
    ...
    public void setQTableMetaData(int experimentNumber, double alpha, double gamma, State state, int iterations, double randomChance)
    {
        ...
        jLabel3.setText(state.toString());
        jLabel4.setText(alphaStr);
        jLabel5.setText(gammaStr);
        jLabel6.setText(randChce);
    }
    ...
    public QTableGUI() {
        ...
        screenshot.addActionListener(
            new ActionListener() {
                public void actionPerformed(ActionEvent ae) 
                {
                    BufferedImage img;
                    try {
                        img = ScreenImage.createImage(temp.getContentPane()); 
                        ScreenImage.writeImage(img, "screenshot.png");
                    } catch (AWTException ex) {
                        Logger.getLogger(QTableGUI.class.getName()).log(Level.SEVERE, null, ex);
                    } catch(Exception e) {
                        e.printStackTrace();
                    }
        ...
        jPanelsState1 = new JPanel[5][5];
        jPanelsState0 = new JPanel[5][5];
        
        jPanelsState0[0][0] = jPanel1;
        jPanelsState0[0][1] = jPanel2;
        jPanelsState0[0][2] = jPanel3;
        jPanelsState0[0][3] = jPanel4;
        jPanelsState0[0][4] = jPanel5;
        jPanelsState0[1][0] = jPanel6;
        jPanelsState0[1][1] = jPanel7;
        jPanelsState0[1][2] = jPanel8;
        jPanelsState0[1][3] = jPanel9;
        jPanelsState0[1][4] = jPanel10;
        jPanelsState0[2][0] = jPanel11;
        jPanelsState0[2][1] = jPanel12;
        jPanelsState0[2][2] = jPanel13;
        jPanelsState0[2][3] = jPanel14;
        jPanelsState0[2][4] = jPanel15;
        jPanelsState0[3][0] = jPanel16;
        jPanelsState0[3][1] = jPanel17;
        jPanelsState0[3][2] = jPanel18;
        jPanelsState0[3][3] = jPanel19;
        jPanelsState0[3][4] = jPanel20;
        jPanelsState0[4][0] = jPanel21;
        jPanelsState0[4][1] = jPanel22;
        jPanelsState0[4][2] = jPanel23;
        jPanelsState0[4][3] = jPanel24;
        jPanelsState0[4][4] = jPanel25;
        
        jPanelsState1[0][0] = jPanel26;
        jPanelsState1[0][1] = jPanel27;
        jPanelsState1[0][2] = jPanel28;
        jPanelsState1[0][3] = jPanel29;
        jPanelsState1[0][4] = jPanel30;
        jPanelsState1[1][0] = jPanel31;
        jPanelsState1[1][1] = jPanel32;
        jPanelsState1[1][2] = jPanel33;
        jPanelsState1[1][3] = jPanel34;
        jPanelsState1[1][4] = jPanel35;
        jPanelsState1[2][0] = jPanel36;
        jPanelsState1[2][1] = jPanel37;
        jPanelsState1[2][2] = jPanel38;
        jPanelsState1[2][3] = jPanel39;
        jPanelsState1[2][4] = jPanel40;
        jPanelsState1[3][0] = jPanel41;
        jPanelsState1[3][1] = jPanel42;
        jPanelsState1[3][2] = jPanel43;
        jPanelsState1[3][3] = jPanel44;
        jPanelsState1[3][4] = jPanel45;
        jPanelsState1[4][0] = jPanel46;
        jPanelsState1[4][1] = jPanel47;
        jPanelsState1[4][2] = jPanel48;
        jPanelsState1[4][3] = jPanel49;
        jPanelsState1[4][4] = jPanel50;  
    ...
    void drawSections(JPanel jp)
    {
        ...
        g1.drawLine(0, 0, jpWidth, jpHeight);
    ...
    void drawTable()
    {
        for (int i = 1; i <= 5; i++) {
            for (int j = 1; j <= 5; j++) {
                ...
                drawPolygons(jPanelsState0[i-1][j-1], j * 1.0f, i * 1.0f, j * -1.0f, i * -1.0f, d);
                drawPolygons(jPanelsState1[i-1][j-1], j * 1.0f, i * 1.0f, j * -1.0f, i * -1.0f, d);
            }
        }   
    }
    ...
    {   
        ...
        if(tableState == 1)
            drawPolygons(jPanelsState1[i-1][j-1], (float)north,(float)west,(float)south,(float)east, d);
        else 
            drawPolygons(jPanelsState0[i-1][j-1], (float)north,(float)west,(float)south,(float)east, d);
    }
    
    public void setSpecialLocations(int i, int j, int tableState)
    {
        if(tableState == 1)
        {
            drawSpecialLocations(jPanelsState1[i-1][j-1]);
        }
        else{
            drawSpecialLocations(jPanelsState0[i-1][j-1]);
        }
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("EXPERIMENT 1");

        jLabel2.setText("Iterations");

        jLabel3.setText("Full State:");

        jLabel4.setText("alpha");

        jLabel5.setText("gamma:");

        jLabel6.setText("Random chance:");
        ...
        jPanel42.setPreferredSize(new java.awt.Dimension(100, 100));
        ...
        jPanel43.setPreferredSize(new java.awt.Dimension(100, 100));
        ...
        jPanel44.setPreferredSize(new java.awt.Dimension(100, 100));
        ...
        jPanel46.setPreferredSize(new java.awt.Dimension(100, 100));
        ...
        jPanel50.setPreferredSize(new java.awt.Dimension(100, 100));
        ...
        jLabel7.setText("Promising action");

        jLabel8.setText("Less promising actions");

        jLabel9.setFont(new java.awt.Font("Lucida Grande", 1, 18)); // NOI18N
        jLabel9.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel9.setText("Q-Table 0 [Agent without a block]");

        jLabel10.setFont(new java.awt.Font("Lucida Grande", 1, 18)); // NOI18N
        jLabel10.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel10.setText("Q-Table 1 [Agent with a block]");
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(jSeparator2, javax.swing.GroupLayout.PREFERRED_SIZE, 1128, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(0, 0, Short.MAX_VALUE)))))
                .addContainerGap())
        );
    ...
    public void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(QTableGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
